                ...
                <section className='w-[500px] h-[600px] p-10 space-y-16'>
                    ...
                    <form onSubmit={handleLoginFormSubmit} className="flex flex-col gap-10">
                        ...
                        <div className="flex flex-col gap-2">
                            <label htmlFor="email">
                                <IconWithText iconName='ph:user-bold' title='Email' />
                            </label>
                        ...
                        <div className="grid grid-col-2 place-content-end">
                            <span />
                            <button type="submit" className="p-3 text-right hover:opacity-100 opacity-80 ease-in-out transition-opacity">Don't have an account?</button>
                        </div>
                    </form>
                </section>
